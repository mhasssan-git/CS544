...
public class UserResources {
	...
	public ResponseEntity<EntityModel<UsersResponseModel>> createUser(@Validated(
			ValidationLevel.onCreate.class) @RequestBody UsersRequestModel usersRequest) {
	...
	public ResponseEntity<EntityModel<UsersResponseModel>> authenticateUser
			(@Validated(ValidationLevel.onAuthenticateUser.class)
			 @RequestBody UsersRequestModel usersRequest) {
		UsersResponseModel respModel = new UsersResponseModel();
